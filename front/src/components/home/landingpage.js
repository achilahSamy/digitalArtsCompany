...
const LandingPage = () => {
  return (
    ...
    <head>
      ...
      <title>Tweny Moments &mdash</title>
    ...
    <div class="fs-me">
      ...
      <div class="me-content">
        ...
        <div class="logo">
          ...
          <img src="/logo5.png" width="115" height="80" alt="Logo" />

        </div>

        <div class="bio">

          <p>... with a diverse <br/> &amp; extensive <Link to='/catalogue'>Catalogue,</Link><br />
           this is a <Link to='/home'>Creative Arts Company,</Link> which prides
             in Versatile <Link to='/home'>Profile.</Link><br />
        ...
        <div class="network">
          ...
          <ul>
            ...
            <li>
              <a class="icon-twitter" href="https://twitter.com/twenymoments">
            ...
            <li>
              <a class="icon-instagram" href="https://www.instagram.com/twenymoments/">
                <svg class="svg-icon" viewBox="0 0 20 20">
        ...
        <div class="credit">
          <p class="copyright">TwenyMoments &copy; 2023 </p>
        </div>
